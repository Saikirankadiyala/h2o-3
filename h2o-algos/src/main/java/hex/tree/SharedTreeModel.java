...
public abstract class SharedTreeModel<
  ...
  public abstract static class SharedTreeOutput extends Model.Output {
    ...
    public ScoreKeeper[] scoreKeepers() {
      return scoreKeepers(ScoreKeeper.StoppingMethods.AUTO, false, false);
    }
    public ScoreKeeper[] scoreKeepers(ScoreKeeper.StoppingMethods stoppingMethod, boolean hasCV, boolean hasValidSet) {
      ...
      if (stoppingMethod.equals(ScoreKeeper.StoppingMethods.AUTO))
        ...
        if (hasCV && hasValidSet) { // has validation dataset and CV enabled
          ska = stoppingMethod.equals(ScoreKeeper.StoppingMethods.xval)?_scored_train:_scored_valid;
